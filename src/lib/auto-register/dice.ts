...
/**
 * Auto-register a new Dice account using the JF email.
 * Registration URL: https://www.dice.com/register
 */
export async function registerDice(
  ...
  try {
    ...
    log.push("Opening Dice registration page…");
    ...
    if (hasCaptcha) {
      ...
      return {
        ...
        message: "CAPTCHA required. Please complete Dice registration manually.",
        requiresManual: true,
        manualInstructions: `Open https://www.dice.com/register and register with email: ${ctx.jfEmail}`,
        log,
      };
    }
    ...
    return {
      ...
      message: `Registration submitted. Check ${ctx.jfEmail} for a verification email from Dice.`,
