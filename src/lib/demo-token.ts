 ...
 *
 * Token format: "{expiresAt}.{signature}" where expiresAt is a Unix
 * timestamp (seconds) and signature is an HMAC-SHA256 hex digest of
 * "demo:{expiresAt}".
 */

export const DEMO_COOKIE = "demo_token";
export const DEMO_TTL_SECONDS = 60 * 60 * 24; // 24 hours
